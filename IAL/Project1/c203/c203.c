...
** QUEUE_MAX. Hodnota QUEUE_SIZE slou¾í k simulaci fronty v rùznì velkém poli
...
**
** Pøi v¹ech operacích se oba indexy (f_index i b_index) v¾dy zvìt¹ují
** s výjimkou pøípadu, kdy index pøesáhne hranici QUEUE_SIZE. V tom pøípadì
...
** Pokud je fronta prázdná, o¹etøete vzniklou chybu voláním
** funkce queueError(QERR_GET). Návratovou hodnota v pøípadì chyby
** je nedefinovaná (stejný pøípad jako queueFront).
**
